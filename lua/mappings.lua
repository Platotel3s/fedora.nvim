...
map("n","<F9>","<cmd>OverseerRun<CR>",{desc="Running Overseer"})
map("n","<F5>","<cmd>OverseerToggle<CR>",{desc="Open Toggle Overseer"})
map("n","<F10>","<cmd>OverseerBuild<CR>",{desc="Build Overseer"})
map("n","<F11>","<cmd>OverseerRun Laravel Dev<CR>",{desc="Laravel Run Dev"})
map("i", "<Tab>", function()
